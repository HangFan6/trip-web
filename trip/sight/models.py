...
class Sight(CommonModel):
    ...
    class Meta:
        ...
        verbose_name = '景点'
        # 列表有多项，在英文中有复数形式，故显示（景点信息s），verbose_name_plural去除复数s
...
class Ticket(CommonModel):
    ...
    return_policy = models.CharField('退改政策', max_length=64, default='退改条件')
...
class Comment(CommonModel):
    ...
    reply = models.ForeignKey('self', blank=True, null=True,
                              ...
                              verbose_name='回复',
                              on_delete=models.CASCADE)
    images = GenericRelation(ImageRelated, verbose_name='关联的图片',
